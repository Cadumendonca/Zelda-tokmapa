function leafletInit() {
  ...
  window.map.setView(
    window.rc.unproject([urlParams.x, urlParams.y]),
    urlParams.z
  );
  ...
  let url =
    "https://raw.githubusercontent.com/berelofonte/Zelda-tokmapa/tiles/assets/tiles";
  ...
  L.DomEvent.on(
    document.getElementsByClassName("leaflet-control-layers-list")[0],
    "click",
    function (ev) {
